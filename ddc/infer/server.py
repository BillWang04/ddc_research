...
from new_onset_net import OnsetNet
from new_sym_net import SymNet
...
if __name__ == '__main__':
    ...
    parser.set_defaults(
        norm_pkl_fp='infer/server_aux/norm.pkl',
        sp_ckpt_fp='infer/server_aux/model_sp-56000',
        ss_ckpt_fp='infer/server_aux/model_ss-23628',
        labels_txt_fp='infer/server_aux/labels_4_0123.txt',
        sp_batch_size=256,
        max_file_size=None,
    )
