...
class SymNet:
    def __init__(self,
        ...
        if do_rnn:
            ...
            rnn_inputs = tf.split(rnn_inputs, nunroll, axis=1)
        ...
        if mode == 'train':
            ...
            train_op = optimizer.apply_gradients(list(zip(grads, tvars)), global_step=tf.compat.v1.train.get_or_create_global_step())
