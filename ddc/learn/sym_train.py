...
# Data
tf.compat.v1.app.flags.DEFINE_string('train_txt_fp', '', 'Training dataset txt file with a list of pickled song files')
tf.compat.v1.app.flags.DEFINE_string('valid_txt_fp', '', 'Eval dataset txt file with a list of pickled song files')
tf.compat.v1.app.flags.DEFINE_string('test_txt_fp', '', 'Test dataset txt file with a list of pickled song files')
tf.compat.v1.app.flags.DEFINE_string('sym_rnn_pretrain_model_ckpt_fp', '', 'File path to model checkpoint with only sym weights')
tf.compat.v1.app.flags.DEFINE_string('model_ckpt_fp', '', 'File path to model checkpoint if resuming or eval')

# Features
tf.compat.v1.app.flags.DEFINE_string('sym_in_type', 'onehot', 'Either \'onehot\' or \'bagofarrows\'')
tf.compat.v1.app.flags.DEFINE_string('sym_out_type', 'onehot', 'Either \'onehot\' or \'bagofarrows\'')
tf.compat.v1.app.flags.DEFINE_integer('sym_narrows', 4, 'Number or arrows in data')
tf.compat.v1.app.flags.DEFINE_integer('sym_narrowclasses', 4, 'Number or arrow classes in data')
tf.compat.v1.app.flags.DEFINE_integer('sym_embedding_size', 32, '')
tf.compat.v1.app.flags.DEFINE_bool('audio_z_score', False, 'If true, train and test on z-score of validation data')
tf.compat.v1.app.flags.DEFINE_integer('audio_deviation_max', 0, '')
tf.compat.v1.app.flags.DEFINE_integer('audio_context_radius', -1, 'Past and future context per training example')
tf.compat.v1.app.flags.DEFINE_integer('audio_nbands', 0, 'Number of bands per frame')
tf.compat.v1.app.flags.DEFINE_integer('audio_nchannels', 0, 'Number of channels per frame')
tf.compat.v1.app.flags.DEFINE_bool('feat_meas_phase', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_meas_phase_cos', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_meas_phase_sin', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_beat_phase', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_beat_phase_cos', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_beat_phase_sin', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_beat_diff', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_beat_diff_next', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_beat_abs', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_time_diff', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_time_diff_next', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_time_abs', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_prog_diff', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_prog_abs', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_diff_feet', False, '')
tf.compat.v1.app.flags.DEFINE_bool('feat_diff_aps', False, '')
tf.compat.v1.app.flags.DEFINE_integer('feat_beat_phase_nquant', 0, '')
tf.compat.v1.app.flags.DEFINE_integer('feat_beat_phase_max_nwraps', 0, '')
tf.compat.v1.app.flags.DEFINE_integer('feat_meas_phase_nquant', 0, '')
tf.compat.v1.app.flags.DEFINE_integer('feat_meas_phase_max_nwraps', 0, '')
tf.compat.v1.app.flags.DEFINE_string('feat_diff_feet_to_id_fp', '', '')
tf.compat.v1.app.flags.DEFINE_string('feat_diff_coarse_to_id_fp', '', '')
tf.compat.v1.app.flags.DEFINE_bool('feat_diff_dipstick', False, '')
tf.compat.v1.app.flags.DEFINE_string('feat_freetext_to_id_fp', '', '')
tf.compat.v1.app.flags.DEFINE_integer('feat_bucket_beat_diff_n', 0, '')
tf.compat.v1.app.flags.DEFINE_float('feat_bucket_beat_diff_max', 0, '')
tf.compat.v1.app.flags.DEFINE_integer('feat_bucket_time_diff_n', 0, '')
tf.compat.v1.app.flags.DEFINE_float('feat_bucket_time_diff_max', 0, '')

# Network params
tf.compat.v1.app.flags.DEFINE_integer('batch_size', 128, 'Batch size for training')
tf.compat.v1.app.flags.DEFINE_integer('nunroll', 1, '')
tf.compat.v1.app.flags.DEFINE_string('cnn_filter_shapes', '', 'CSV 3-tuples of filter shapes (time, freq, n)')
tf.compat.v1.app.flags.DEFINE_string('cnn_pool', '', 'CSV 2-tuples of pool amounts (time, freq)')
tf.compat.v1.app.flags.DEFINE_integer('cnn_dim_reduction_size', -1, '')
tf.compat.v1.app.flags.DEFINE_float('cnn_dim_reduction_keep_prob', 1.0, '')
tf.compat.v1.app.flags.DEFINE_string('cnn_dim_reduction_nonlin', '', '')
tf.compat.v1.app.flags.DEFINE_string('rnn_cell_type', 'lstm', '')
tf.compat.v1.app.flags.DEFINE_integer('rnn_size', 0, '')
tf.compat.v1.app.flags.DEFINE_integer('rnn_nlayers', 0, '')
tf.compat.v1.app.flags.DEFINE_float('rnn_keep_prob', 1.0, '')
tf.compat.v1.app.flags.DEFINE_string('dnn_sizes', '', 'CSV sizes for dense layers')
tf.compat.v1.app.flags.DEFINE_float('dnn_keep_prob', 1.0, '')

# Training params
tf.compat.v1.app.flags.DEFINE_float('grad_clip', 0.0, 'Clip gradients to this value if greater than 0')
tf.compat.v1.app.flags.DEFINE_string('opt', 'sgd', 'One of \'sgd\'')
tf.compat.v1.app.flags.DEFINE_float('lr', 1.0, 'Learning rate')
tf.compat.v1.app.flags.DEFINE_float('lr_decay_rate', 1.0, 'Multiply learning rate by this value every epoch')
tf.compat.v1.app.flags.DEFINE_integer('lr_decay_delay', 0, '')
tf.compat.v1.app.flags.DEFINE_integer('nbatches_per_ckpt', 100, 'Save model weights every N batches')
tf.compat.v1.app.flags.DEFINE_integer('nbatches_per_eval', 10000, 'Evaluate model every N batches')
tf.compat.v1.app.flags.DEFINE_integer('nepochs', 0, 'Number of training epochs, negative means train continuously')
tf.compat.v1.app.flags.DEFINE_string('experiment_dir', '', 'Directory for temporary training files and model weights')

# Eval params

# Generate params
tf.compat.v1.app.flags.DEFINE_string('generate_fp', '', '')
tf.compat.v1.app.flags.DEFINE_string('generate_vocab_fp', '', '')
...
def main(_):
    ...
    charts_train = list([x for x in charts_train if x.get_nannotations() >= FLAGS.nunroll])
    ...
    # Create model config
    rnn_proj_init = tf.constant_initializer(0.0, dtype=dtype) if FLAGS.sym_rnn_pretrain_model_ckpt_fp else tf.compat.v1.uniform_unit_scaling_initializer(factor=1.0, dtype=dtype)
    model_config = {
        ...
        'cnn_init': tf.compat.v1.uniform_unit_scaling_initializer(factor=1.43, dtype=dtype),
        'cnn_pool': stride_csv_arg_list(FLAGS.cnn_pool, 2, int),
        'cnn_dim_reduction_size': FLAGS.cnn_dim_reduction_size,
        'cnn_dim_reduction_init': tf.compat.v1.uniform_unit_scaling_initializer(factor=1.0, dtype=dtype),
        ...
        'rnn_init': tf.compat.v1.random_uniform_initializer(-5e-2, 5e-2, dtype=dtype),
        'nunroll': FLAGS.nunroll,
        'rnn_keep_prob': FLAGS.rnn_keep_prob,
        'dnn_sizes': stride_csv_arg_list(FLAGS.dnn_sizes, 1, int),
        'dnn_init': tf.compat.v1.uniform_unit_scaling_initializer(factor=1.15, dtype=dtype),
    ...
    with tf.Graph().as_default(), tf.compat.v1.Session() as sess:
        if do_train:
            ...
            with tf.compat.v1.variable_scope('model_ss', reuse=None):
        ...
        if do_train_eval or do_eval:
            ...
            with tf.compat.v1.variable_scope('model_ss', reuse=do_train):
                eval_batch_size = FLAGS.batch_size
                if FLAGS.rnn_size > 0 and FLAGS.rnn_nlayers > 0:
                    eval_batch_size = 1
                model_eval = SymNet(mode='eval', batch_size=eval_batch_size, **model_config)
                model_early_stop_xentropy_avg = tf.compat.v1.train.Saver(tf.compat.v1.global_variables(), max_to_keep=None)
                model_early_stop_accuracy = tf.compat.v1.train.Saver(tf.compat.v1.global_variables(), max_to_keep=None)
        ...
        if FLAGS.model_ckpt_fp:
            ...
            if FLAGS.sym_rnn_pretrain_model_ckpt_fp:
                ...
                var_list_old = [x for x in tf.compat.v1.global_variables() if 'nosym' not in x.name and 'cnn' not in x.name]
                pretrain_saver = tf.compat.v1.train.Saver(var_list_old)
                pretrain_saver.restore(sess, FLAGS.sym_rnn_pretrain_model_ckpt_fp)

        # Create summaries
        if do_train:
            summary_writer = tf.summary.create_file_writer(FLAGS.experiment_dir)

            epoch_mean_xentropy = tf.compat.v1.placeholder(tf.float32, shape=[], name='epoch_mean_xentropy')
            epoch_mean_time = tf.compat.v1.placeholder(tf.float32, shape=[], name='epoch_mean_time')
            epoch_var_xentropy = tf.compat.v1.placeholder(tf.float32, shape=[], name='epoch_var_xentropy')
            epoch_var_time = tf.compat.v1.placeholder(tf.float32, shape=[], name='epoch_var_time')
            epoch_time_total = tf.compat.v1.placeholder(tf.float32, shape=[], name='epoch_time_total')
            epoch_summaries = tf.compat.v1.summary.merge([
                tf.compat.v1.summary.scalar('epoch_mean_xentropy', epoch_mean_xentropy),
                tf.compat.v1.summary.scalar('epoch_mean_time', epoch_mean_time),
                tf.compat.v1.summary.scalar('epoch_var_xentropy', epoch_var_xentropy),
                tf.compat.v1.summary.scalar('epoch_var_time', epoch_var_time),
                tf.compat.v1.summary.scalar('epoch_time_total', epoch_time_total)
            ])
            ...
            for eval_metric_name in eval_metric_names:
                ...
                ph_mean = tf.compat.v1.placeholder(tf.float32, shape=[], name=name_mean)
                ph_var = tf.compat.v1.placeholder(tf.float32, shape=[], name=name_var)
                summary_mean = tf.compat.v1.summary.scalar(name_mean, ph_mean)
                summary_var = tf.compat.v1.summary.scalar(name_var, ph_var)
                eval_summaries.append(tf.compat.v1.summary.merge([summary_mean, summary_var]))
                eval_metrics[eval_metric_name] = (ph_mean, ph_var)
            eval_time = tf.compat.v1.placeholder(tf.float32, shape=[], name='eval_time')
            eval_time_summary = tf.compat.v1.summary.scalar('eval_time', eval_time)
            eval_summaries = tf.compat.v1.summary.merge([eval_time_summary] + eval_summaries)
            ...
            # Init epoch
            model_train.assign_lr(sess, FLAGS.lr)
            with summary_writer.as_default():
                tf.summary.scalar('learning rate', FLAGS.lr, step=0)
            epoch_xentropies = []
            epoch_times = []
            ...
            while FLAGS.nepochs < 0 or batch_num < nbatches:
                if batch_num % 10000 == 0:
                    print(('batch_num: {} of {} total epochs'.format(batch_num, nbatches)))
                ...
                if batch_num % batches_per_epoch == 0:
                    ...
                    model_train.assign_lr(sess, FLAGS.lr * lr_decay)
                    with summary_writer.as_default():
                        tf.summary.scalar('learning rate', FLAGS.lr * lr_decay, step=batch_num)
                    ...
                    with summary_writer.as_default():
                        tf.summary.scalar('epoch_summary', epoch_summary, step=batch_num)
                ...
                if batch_num % FLAGS.nbatches_per_ckpt == 0:
                    ...
                    print(('ckpt_fp: {}'.format(ckpt_fp)))
                    model_saver.save(sess, ckpt_fp, global_step=tf.compat.v1.train.get_or_create_global_step())
                    print ('Done saving!')
                ...
                if do_train_eval and batch_num % FLAGS.nbatches_per_eval == 0:
                    ...
                    eval_summary = sess.run(eval_summaries, feed_dict=feed_dict)
                    with summary_writer.as_default():
                        tf.summary.scalar('eval_summary', eval_summary, step=batch_num)
                    ...
                    if xentropy_avg_mean < eval_best_xentropy_avg:
                        ...
                        model_early_stop_xentropy_avg.save(sess, ckpt_fp, global_step=tf.compat.v1.train.get_or_create_global_step())
                    ...
                    if accuracy_mean > eval_best_accuracy:
                        ...
                        model_early_stop_accuracy.save(sess, ckpt_fp, global_step=tf.compat.v1.train.get_or_create_global_step())
